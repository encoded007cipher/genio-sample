...
public class SayHelloResponse {
	 ...
	 */
	public SayHelloResponse(String message) {
	 ...
	 * Setter for message
	 */
	public SayHelloResponse setMessage(String message) {
		this.message = message;
		return this;
	}
	 ...
	 */	
	public SayHelloResponse (Node node) throws XPathExpressionException {
